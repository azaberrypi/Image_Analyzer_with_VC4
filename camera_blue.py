...
with Driver() as drv:
    ...
    code=drv.program(histogram_blue)
    ...
    try:
        ...
        while True:
            ...
            hdmi.addColoredText(draw_img, *(10, 32 * 1), "VideoCore IV", "blue")
            ...
            for i in range(16):
                hdmi.printColoredRectangle(histogram_img, "blue", i*(WINDOW_W/16), H*2 - (sum[i] * (H*2 / 115200)), (i+1)*(WINDOW_W/16), H*2)    # 第2~引数で位置を指定
